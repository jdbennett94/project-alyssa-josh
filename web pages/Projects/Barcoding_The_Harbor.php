...
<html>
  <head>
    ...
    <title>Scramble and Synthetic Yeast</title>
  ...
  <body class="bg-black">
      ...
      <div class="collapse navbar-collapse" id="navbarColor02">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="#">Scramble and Synthetic Yeast</a>
              <a class="dropdown-item active" href="#">Barcoding the Harbor</a>
            </div>
          </li>
          <li class="nav-item">
    ...
    <footer>
      ...
      <div class="row justify-content-around text-center">
        ...
        <div class="col text-secondary">
          Email: <a class="link-light" href="mailto:info@bugssonline.org">info@bugssonline.org</a>
        </div>
      </div>
    </footer>
